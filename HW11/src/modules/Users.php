...
class Users
{
    ...
    public function findOne(int $id): array
    {
        ...
        $connect = new Connector();
        $query = $connect->connect()->query("SELECT * FROM Users WHERE id=" . $id, PDO::FETCH_ASSOC);
        $users = $query->fetchAll();
        return $users;
    }
    ...
    public function updateUser(array $data, int $condition): bool {
        try {
            $update = new Update();
    ...
    public function deleteUser($condition): bool
    {
        try {
            $delete = new Delete();
